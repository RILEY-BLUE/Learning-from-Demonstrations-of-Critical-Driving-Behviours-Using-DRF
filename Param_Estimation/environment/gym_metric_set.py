...
class CLEMetricSet(metric_set.L5MetricSet):
    ...
    def build_validators(self) -> List[validators.SupportsMetricValidate]:
        ...
        return [
            ...
            validators.RangeValidator("collision_rear", metrics.CollisionRearMetric, max_value=0, violation_duration_s=0.1,
                                      duration_mode=validators.DurationMode.TOTAL),
            validators.RangeValidator("collision_side", metrics.CollisionSideMetric, max_value=0, violation_duration_s=0.1,
                                      duration_mode=validators.DurationMode.TOTAL),
